...
Данной предметной области попросту необходима информационная система без неё интернет-магазин не сможет функционировать. 
